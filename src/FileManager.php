...
class FileManager
{
     ...
     * @return array
     */
    public function content($disk, $path, $search)
    {
        // get content for the selected directory
        $content = $this->getContent($disk, $path, $search);
     ...
     * @return array
     */
    public function tree($disk, $path, $search)
    {
        $directories = $this->getDirectoriesTree($disk, $path, $search);
